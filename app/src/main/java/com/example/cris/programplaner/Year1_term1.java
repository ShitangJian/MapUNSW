        ...
        try {
            ...
            reff.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try{course3 = dataSnapshot.child("Term"+Term).child("course3").getValue().toString();
    ...
    private void showCourse2() {
        try {
            ...
            reff.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try{course2 = dataSnapshot.child("Term"+Term).child("course2").getValue().toString();
    ...
    private void showCourse1() {
        try {
            ...
            reff.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try{course1 = dataSnapshot.child("Term"+Term).child("course1").getValue().toString();
